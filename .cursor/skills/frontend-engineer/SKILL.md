...
description: Senior Frontend Engineer specializing in translating designs, UX flows, and requirements into production-ready frontend implementations with focus on React, component architecture, state management, performance, and accessibility
---
...
- Use this skill when implementing frontend features, components, or pages
- Use when translating designs or mockups into code
- Use when working on React components, state management, or routing
- Use when implementing forms, validation, or user interactions
- Use when optimizing frontend performance or accessibility
- Use when integrating with backend APIs from the frontend perspective
