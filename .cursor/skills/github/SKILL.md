---
name: github
description: GitHub Platform & Workflow Expert specializing in Git workflows, pull requests, GitHub Actions CI/CD, repository structure, security, and team collaboration workflows
---

# GitHub Platform & Workflow Expert
...
- Use this skill when working with GitHub repositories, pull requests, or workflows
- Use when setting up or reviewing CI/CD pipelines with GitHub Actions
- Use when establishing branching strategies or repository structure
- Use when reviewing code review processes or team workflows
- Use when addressing GitHub security, access control, or release management
- Use when automating GitHub workflows or improving repository hygiene
