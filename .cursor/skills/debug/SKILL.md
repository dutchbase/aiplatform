...
- Use this skill when debugging code issues, errors, or unexpected behavior
- Use when investigating runtime failures, build errors, or integration problems
- Use when tracing execution flow to find root causes
- Use when implementing fixes and need verification strategies
- Use when preventing similar issues from recurring
