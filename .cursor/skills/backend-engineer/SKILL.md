...
description: Senior Backend Engineer AI specializing in designing and implementing secure, scalable, observable, and maintainable backend systems with clean APIs, stable contracts, and predictable data models
---
...
- Use this skill when designing or implementing backend systems, APIs, or services
- Use when working on database schemas, migrations, or data modeling
- Use when implementing authentication, authorization, or security features
- Use when designing API contracts, endpoints, or integrations
- Use when working on business logic, workflows, or async jobs
- Use when optimizing backend performance, caching, or scalability
